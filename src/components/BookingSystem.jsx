...
export default function BookingModal({ tourId, tourTitle, price, onClose, onConfirm }) {
                    ...
                    <div className="flex items-center mb-6">
                        {[1, 2, 3].map((s) => (
                            <div key={s} className="flex items-center">
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${s <= step ? 'bg-terracotta-500 text-white' : 'bg-gray-200 text-gray-600'
                                    }`}>
                                    ...
                                    <div className="space-y-2">
                                        {['card', 'paypal', 'apple'].map((method) => (
                                            <button
                                                ...
                                                className={`w-full p-3 rounded-xl border flex items-center space-x-3 transition-all ${bookingData.paymentMethod === method
